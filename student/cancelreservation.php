...
if ($isComplete) {
    ...
    $updatequery = "UPDATE $tabletitle SET CANCEL=1 WHERE sessionid='$sessionid' AND studentid='$username';";
    
    // run the insert statement
    queryDB($updatequery, $db);

    //update student budget for course which session is tutoring
    $updatequery1 = "UPDATE $tabletitle2, $tabletitle,$tabletitle3 SET $tabletitle2.currbudget=$tabletitle2.currbudget+1
